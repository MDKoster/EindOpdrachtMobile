    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.description}>
          ...
          committed to reducing our environmental footprint at every step of the
          way.
        </Text>
        <Text style={styles.description}>
          ...
          polyester, and other sustainable fabrics to minimize the impact on the
          environment.
        </Text>
        <Text style={styles.description}>
          In our manufacturing processes, we've implemented energy-efficient
          technologies and reduced water consumption. By investing in renewable
          energy and optimizing production lines, we've significantly decreased
        ...
        <Text style={styles.description}>
          ...
          dyes. These initiatives have not only improved sustainability but also
          resonated with our environmentally conscious customers.
        </Text>
        <Text style={styles.description}>
          Looking ahead, we're committed to further enhancing our sustainability
          efforts. Our future plans include investing in innovative recycling
          technologies, exploring alternative packaging solutions, and
          collaborating with like-minded organizations to drive positive change
